...
Pagination.prototype = {
    ...
    render() {
        ...
        this.operateArea.style.marginRight = "30px";
        // this.operateArea.style.border = "1px solid #888";
        this.operateArea.style.marginBottom = "20px";
        this.operateArea.style.marginTop = "30px";
    ...
    renderNumberArea() {
        ...
        if (this.total > 10) {
            ...
            if (this.currentPage < 4) {
                // 循环前四个 
                for (var i = 0; i < 5; i++) {
                    str += "<span style='cursor: pointer; flex:1; " + (i === this.currentPage ? "color: red" : "") + "'  >" + (i + 1) + "</span>"
                ...
                // 加上中间的...
                str += "<span style='cursor: pointer; flex:1'>...</span>";
                // 加上后面的两个
                str += "<span style='cursor: pointer; flex: 1'>" + (this.total - 1) + "</span>"
                str += "<span style='cursor: pointer; flex: 1'>" + this.total + "</span>"
                ...
                // 第一页
                str += "<span style=' cursor: pointer;flex: 1'>" + 1 + "</span>"
                // 第二页
                str += "<span style=' cursor: pointer;flex: 1'>" + 2 + "</span>"
                // 加上中间的...
                str += "<span style=' cursor: pointer;flex:1'>...</span>";
                // 循环后七个
